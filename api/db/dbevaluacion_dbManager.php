...
function getConnection() {
	...
	global $db_evaluacion_db_Url, $db_evaluacion_db_User, $db_evaluacion_db_Pass, $db_evaluacion_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_evaluacion_db_Url.";dbname=".$db_evaluacion_db_DbName, $db_evaluacion_db_User, $db_evaluacion_db_Pass);
